Public Class frmVinculadoCadastro
    ...
    Private Sub frmVinculadoCadastro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Show()
        ...
        If _Operacao = clsFuncoesGerais.Operacao.Alteracao Then
            ...
            drDados = clnVinculo.ListarDadosVinculo(Codigo)

            If drDados.Read = True Then
                txtNomeVinculado.Text = drDados("vinc_nome")
                txtCPFVinculado.Text = drDados("vinc_CPF")
                txtTipoVinculo.Text = drDados("vinc_vinculo")
            End If
        End If
    End Sub
