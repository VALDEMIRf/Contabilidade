...
Public Class frmVinculadoConsulta
    ...
    Private Sub dgvGridVinculo_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvGridVinculo.CellContentClick

    End Sub

    Private Sub btEnviarNome_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btEnviarNome.Click
        dadosEnviados()
    End Sub
        ...
        Select Case _ConsultaTipo
            Case TipoConsulta.Vinculo
                ...
                If dgvGridVinculo.RowCount <> 0 Then
                    _vinc_id = dgvGridVinculo.CurrentRow.Cells(0).Value
                    '_cli_id = dgvGridVinculo.CurrentRow.Cells(1).Value
                    '_vinc_nome = dgvGridVinculo.CurrentRow.Cells(2).Value
                    _vinc_CPF = dgvGridVinculo.CurrentRow.Cells(3).Value
                    _vinc_vinculo = dgvGridVinculo.CurrentRow.Cells(4).Value
