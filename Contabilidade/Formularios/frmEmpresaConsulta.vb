Public Class frmEmpresaConsulta
    ...
    Private Sub CarregaGrid()
        ...
        Dim dsConsulta2 As New Data.DataSet
        Select Case _ConsultaTipo
            Case TipoConsulta.Cliente
                Dim clnCliente As New clsCliente
                dsConsulta = clnCliente.ListaCliente(txtCPFConsulta.Text)

                'Case TipoConsulta.Empresa
                '    Dim clnEmpresa As New clsEmpresa
                '    dsConsulta2 = clnEmpresa.Listar(txtCPFConsulta.Text)

        End Select
        dgvGridEmpresa.DataSource = dsConsulta.Tables(0)
        '  dgvtesteEmpresa.DataSource = dsConsulta2.Tables(0)
    ...
    Private _empr_TelCel1 As String
    Public Property empr_TelCel1() As String
        Get
            Return _empr_TelCel1
        End Get
        Set(ByVal value As String)
            _empr_TelCel1 = value
        End Set
    ...
    Private _empr_TelCel2 As String
    Public Property empr_TelCel2() As String
        Get
            Return _empr_TelCel2
        End Get
        Set(ByVal value As String)
            _empr_TelCel2 = value
        End Set
    ...
    Private _empr_ValReceitaPJ As String
    Public Property empr_ValReceitaPJ() As String
        Get
            Return _empr_ValReceitaPJ
        End Get
        Set(ByVal value As String)
            _empr_ValReceitaPJ = value
        End Set
    End Property
        ...
        Select Case _ConsultaTipo
            Case TipoConsulta.Cliente
                ...
                If dgvGridEmpresa.RowCount <> 0 Then
                    ...
                    _cli_Dia = dgvGridEmpresa.CurrentRow.Cells(7).Value.ToString
                    _cli_Mes = dgvGridEmpresa.CurrentRow.Cells(8).Value.ToString
                    _cli_Ano = dgvGridEmpresa.CurrentRow.Cells(9).Value.ToString
                    _cli_Logradouro = dgvGridEmpresa.CurrentRow.Cells(10).Value
                    _cli_Numero = dgvGridEmpresa.CurrentRow.Cells(11).Value
                    _cli_complemento = dgvGridEmpresa.CurrentRow.Cells(12).Value
                    _cli_Bairro = dgvGridEmpresa.CurrentRow.Cells(13).Value
                    _cli_Cidade = dgvGridEmpresa.CurrentRow.Cells(14).Value
                    _cli_UF = dgvGridEmpresa.CurrentRow.Cells(15).Value
                    _cli_CEP = dgvGridEmpresa.CurrentRow.Cells(16).Value
                    _cli_FoneRes = dgvGridEmpresa.CurrentRow.Cells(17).Value
                    _cli_FoneCel = dgvGridEmpresa.CurrentRow.Cells(18).Value.ToString
                    _cli_FoneCel2 = dgvGridEmpresa.CurrentRow.Cells(19).Value.ToString
                    _cli_Email = dgvGridEmpresa.CurrentRow.Cells(20).Value
                    _cli_observacoes = dgvGridEmpresa.CurrentRow.Cells(21).Value
                    _cli_Autonomo = dgvGridEmpresa.CurrentRow.Cells(22).Value
                    _cli_PJ = dgvGridEmpresa.CurrentRow.Cells(23).Value
                    _cli_MEI = dgvGridEmpresa.CurrentRow.Cells(24).Value
                    _cli_Curriculo = dgvGridEmpresa.CurrentRow.Cells(25).Value
                    _cli_Aposentado = dgvGridEmpresa.CurrentRow.Cells(26).Value
                    _cli_NumBeneficio = dgvGridEmpresa.CurrentRow.Cells(27).Value
                    _cli_FuncPublico = dgvGridEmpresa.CurrentRow.Cells(28).Value
                    _cli_NomeFunc = dgvGridEmpresa.CurrentRow.Cells(29).Value
                    _cli_Falecido = dgvGridEmpresa.CurrentRow.Cells(30).Value
                    _cli_DataFalecido = dgvGridEmpresa.CurrentRow.Cells(31).Value
                    _cli_Inativo = dgvGridEmpresa.CurrentRow.Cells(32).Value
                    _cli_InativoObs = dgvGridEmpresa.CurrentRow.Cells(33).Value
                    _cli_EmprDom = dgvGridEmpresa.CurrentRow.Cells(34).Value
                    _cli_ESocial = dgvGridEmpresa.CurrentRow.Cells(35).Value
                    _cli_EsocialSenha = dgvGridEmpresa.CurrentRow.Cells(36).Value
                    _cli_Parcelamento = dgvGridEmpresa.CurrentRow.Cells(37).Value
                    _cli_NumParcelamento = dgvGridEmpresa.CurrentRow.Cells(38).Value
                    _cli_VIP = dgvGridEmpresa.CurrentRow.Cells(39).Value
                    _cli_VIPDescricao = dgvGridEmpresa.CurrentRow.Cells(40).Value
                    ...
                    _empr_NIRE = dgvGridEmpresa.CurrentRow.Cells(62).Value
                    _empr_CCM = dgvGridEmpresa.CurrentRow.Cells(63).Value
                    _empr_Porte = dgvGridEmpresa.CurrentRow.Cells(64).Value
                    _empr_atividade = dgvGridEmpresa.CurrentRow.Cells(65).Value
                    _empr_dataInicio = dgvGridEmpresa.CurrentRow.Cells(66).Value
                    ' _clsCliente.cli_id = dgvGridEmpresa.CurrentRow.Cells(67).Value
                    '_clsCategoria.cat_ID = dgvGridEmpresa.CurrentRow.Cells(68).Value
                    _empr_TelCel1 = dgvGridEmpresa.CurrentRow.Cells(69).Value.ToString
                    _empr_TelCel1 = dgvGridEmpresa.CurrentRow.Cells(70).Value.ToString
                    _empr_endereco = dgvGridEmpresa.CurrentRow.Cells(71).Value
                    _empr_numero = dgvGridEmpresa.CurrentRow.Cells(72).Value
                    _empr_complemento = dgvGridEmpresa.CurrentRow.Cells(73).Value
                    _empr_bairro = dgvGridEmpresa.CurrentRow.Cells(74).Value
                    _empr_cidade = dgvGridEmpresa.CurrentRow.Cells(75).Value
                    _empr_UF = dgvGridEmpresa.CurrentRow.Cells(76).Value
                    _empr_CEP = dgvGridEmpresa.CurrentRow.Cells(77).Value
                    _empr_obs = dgvGridEmpresa.CurrentRow.Cells(78).Value
                    _empr_Simples = dgvGridEmpresa.CurrentRow.Cells(79).Value
                    _empr_SimplesNacional = dgvGridEmpresa.CurrentRow.Cells(80).Value
                    _empr_Simei = dgvGridEmpresa.CurrentRow.Cells(81).Value
                    _empr_CodSimei = dgvGridEmpresa.CurrentRow.Cells(82).Value
                    _empr_sefaz = dgvGridEmpresa.CurrentRow.Cells(83).Value
                    _empr_SefazUsu = dgvGridEmpresa.CurrentRow.Cells(84).Value
                    _empr_SefazSen = dgvGridEmpresa.CurrentRow.Cells(85).Value
                    _empr_CodReceitaPJ = dgvGridEmpresa.CurrentRow.Cells(86).Value
